...
create function public.answer_quiz_question_v3(
  p_student_id uuid,
  p_attempt_id uuid,
  p_question_id uuid,
  p_phase text,
...
create or replace function public.resume_quiz_after_feedback_v1(
  p_student_id uuid,
  p_attempt_id uuid,
...
revoke all on function public.resume_quiz_after_feedback_v1(
  uuid,
  uuid,
  uuid,
  text
...
grant execute on function public.resume_quiz_after_feedback_v1(
  uuid,
  uuid,
  uuid,
  text
