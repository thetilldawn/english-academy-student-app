...
-- User-directed corrections are display-only overlays. The source hash for
...
create function private.list_entry_approved_korean_pronunciations_v1(
...
create function public.list_entry_approved_korean_pronunciations_v1(p_vocab_entry_ids bigint[])
returns table(vocab_entry_id bigint, dictionary_id text, approval jsonb, identity jsonb)
