...
describe("일괄 단어 시험 입력 계약", () => {
  ...
  it.each([["canonical_example_to_headword",0],["canonical_definition_to_headword",0],["canonical_headword_to_definition",100]])("%s는 공통 회차·날짜 계획을 지원한다",(questionMode,englishToKoreanRatio)=>{
