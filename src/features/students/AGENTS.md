...
- APP-20260907-01: 위 60초는 학생 관리의 기본 표시 상한이다. 배정 소비자만 현재 화면의 성공 자료를 유지해 작성창이 갑자기 닫히지 않게 한다. 목록 신선도 안내/수동 갱신과 작성 입력 수명을 분리하며 복귀·계정·401/403의 개인 자료 보호는 완화하지 않는다.
