export const adminStudentsText = {
  ...
  page: {
    ...
    expired: "최신 학생 목록을 다시 확인해 주세요.",
    retainedAssignmentList: "학생 목록은 이전에 불러온 내용입니다. 작성 중인 배정은 유지됩니다.",
    retainedStudentList: "이전에 불러온 학생 목록입니다. 최신 내용은 다시 불러와 확인할 수 있습니다.",
    refreshingList: "학생 목록을 새로 불러오는 중입니다.",
  ...
  info: {
    ...
    profileUnknown: "저장됐는지 확인하지 못했습니다. 입력은 유지했습니다. 저장 결과를 먼저 확인해 주세요.",
    profileConflict: "다른 변경이 먼저 저장되었습니다. 현재 입력을 확인한 뒤 다시 저장해 주세요.",
    profileAuthError: "관리자 로그인이 필요합니다.",
    profileCheck: "저장 결과 확인",
    profileChecking: "저장 결과 확인 중…",
    profileChecked: "저장된 내용을 확인했습니다. 작성 중인 입력은 유지했습니다. 확인 후 다시 저장해 주세요.",
    profileCheckError: "저장 결과를 불러오지 못했습니다. 입력은 유지했습니다. 다시 확인해 주세요.",
