export const adminLearningText = {
  ...
  assignmentModal: {
    ...
    range: {
      ...
      maximumQuestionCount: "현재 최대 {count}개",
    ...
    submit: {
      ...
      blockedReason: {
        ...
        loadFailed: "불러오기 실패",
        unchanged: "변경 내용 없음",
        capacityLoading: "단어 수 계산 중",
        capacityFailed: "단어 수 계산 실패",
        rangeUnavailable: "출제 단어 부족",
        questionCountTooLow: "단어 수 부족",
        questionCountTooHigh: "단어 수 초과",
    ...
    errors: {
      ...
      tooMany: "단어 수를 현재 배정 가능한 최대값 이하로 줄여주세요.",
      tooFew: "단어 수를 현재 필요한 최소값 이상으로 늘려주세요.",
      countRange: "총 단어 수는 4개 이상 500개 이하여야 합니다.",
      generic: "단어 시험을 배정하지 못했습니다.",
      maximumDetail:
        "현재 최대 {count}개입니다. 단어 수를 {count}개 이하로 줄여주세요.",
      minimumDetail:
        "현재 조건에는 최소 {count}개가 필요합니다. 단어 수를 늘려주세요.",
      countDetail: "총 단어 수는 {min}개 이상 500개 이하여야 합니다.",
