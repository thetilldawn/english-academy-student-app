export const adminHistoryText = {
  // 개요·내역 > 검색, 더보기, 변경 후 목록 갱신
  read: {
    loading: "시험 내역을 불러오는 중입니다.",
    previous: "이전 검색 결과입니다.",
    expired: "최신 시험 내역을 다시 확인해 주세요.",
    retry: "다시 시도",
    login: "관리자 로그인",
    loadMore: "10개 더보기",
    sectionEmpty: "이 구역에 내역이 없습니다.",
    failure: {
      unavailable: "시험 내역을 불러오지 못했습니다. 다시 시도해 주세요.",
      timeout: "시험 내역 응답이 늦어지고 있습니다. 다시 시도해 주세요.",
      "invalid-response": "시험 내역을 확인하지 못했습니다. 다시 시도해 주세요.",
      "invalid-request": "내역을 불러오지 못했습니다. 검색 조건을 바꾸거나 다시 시도해 주세요.",
      unauthenticated: "관리자 로그인을 확인하지 못했습니다. 다시 로그인해 주세요.",
      forbidden: "이 내역을 볼 수 없습니다. 관리자 계정으로 다시 로그인해 주세요.",
    },
  },
