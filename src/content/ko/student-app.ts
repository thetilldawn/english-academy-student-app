export const studentAppText = {
  ...
  dashboard: {
    ...
    release: {
      ...
      checkSchedule: "시험 일정을 확인해야 합니다. 선생님께 문의해 주세요.",
      held: "이 회차는 보류되었습니다. 다음 회차를 확인해 주세요.",
      cancelled: "이 회차는 취소되었습니다. 선생님께 문의해 주세요.",
    },
  ...
  study: {
    ...
    open: "단어 보기",
    close: "닫기",
    countPrefix: "이 시험에 배정된 학습 단어 ",
    countSuffix: "개 · 단어장 전체 수록 수와 다를 수 있습니다. 시험 전에 뜻과 발음을 확인해 보세요.",
